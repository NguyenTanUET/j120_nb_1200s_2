...
4. Records results in result/j120_no_bound_1200s_2.csv with columns:
...
def main():
    ...
    output_file = result_dir / "j120_no_bound_1200s_2.csv"

    # Create result directory if it doesn't exist
    os.makedirs(result_dir, exist_ok=True)

    # Define the range of files to process
    start_file = "j12053_4.data"  # File bắt đầu
    ...
    local_path = "result/j120_no_bound_1200s_2.csv"
